...
plt.plot(df.index, df['Calorii'], label='Calorii', marker='*', color = 'blue') 
...
plt.figure(figsize=(12, 8))#dimensionarea ferestrei cu grafic
plt.plot(df.index[:4], df['Durata'][:4], label='Durata', marker='*', color = '#4CAF50')
plt.plot(df.index[:4], df['Puls'][:4], label='Puls', marker='*', color = 'hotpink')
plt.plot(df.index[:4], df['MaxPuls'][:4], label='MaxPuls', marker='*', color = '#6A3DAC')
plt.plot(df.index[:4], df['Calorii'][:4], label='Calorii', marker='*', color = '#ffca33')
...
plt.figure(figsize=(12, 8))#dimensionarea ferestrei cu grafic
plt.plot(df.index[-10:], df['Durata'].tail(10), label='Durata', marker='*', color = '#4CAF50')
plt.plot(df.index[-10:], df['Puls'].tail(10), label='Puls', marker='*', color = 'hotpink')
